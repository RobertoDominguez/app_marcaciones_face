...
class RouteGenerator{
  static Route<dynamic> generateRoute(RouteSettings settings){
    ...
    switch (name){
      ...
      case facesRoute:
        return middleware(guards: ['auth'], builder: const FacesIndex(), settings: settings);
      case registrarFaceRoute:
        return middleware(guards: ['auth'], builder: const RegistroBiometrico(), settings: settings);
